...
const BOTAO_APAGAR_HISTORICO = "btnApagarHistorico";
...
const QUANTIDADE_PIZZA = "selQuantidade";
...
const MORADA_CLIENTE = "txtMorada"
 ...
 * @param {string} dnasc - Data de Nascimento do cliente.
 */
function Cliente(nome, morada, dnasc) {
 ...
 * @param {Quantidade} quantidade - Var com a quantidade de Pizzas
 */
...
function obtemDadosCliente() {
  ...
  return new Cliente(formulario.elements[NOME_CLIENTE].value,
      ...
      formulario.elements[DNASC].value);
}
...
function obtemQuantidadePizas() {
  ...
  // Exercício: Colocar aqui o código em falta.
  let quantidade = formulario.elements[QUANTIDADE_PIZZA].value;
  return quantidade;
}
