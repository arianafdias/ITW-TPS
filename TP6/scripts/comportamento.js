...
function processaDoisNumeros(){
  var x = Number(window.prompt('primeiro número?'));
  var y = Number(window.prompt('segundo número?'));
  return (`os números digitados foram ${x} e ${y}, o maior é ${maiorDeDoisNumeros(x,y)}, e o menor é ${menorDeDoisNumeros(x,y)}`)
}
